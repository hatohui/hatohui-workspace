...
| `cloudflare-docs`      | Remote HTTP    | Looking up current Cloudflare product documentation. No auth. Same role as `aws-knowledge`, for Cloudflare — use instead of guessing Cloudflare behavior from training data.                                                                                                                                                                                                                |
