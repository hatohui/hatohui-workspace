...
import { renderBirthdayEmail } from '@/modules/cron/utils/birthday-email-templates';
...
import {
  ...
  SENT_RETENTION_DAYS,
} from '@/modules/cron/birthday.constants';
import {
  civilDateIn,
  formatCivilDateLong,
  nextOccurrence,
  toUtcDate,
  type CivilDate,
} from '@/modules/cron/utils/birthday-schedule';
import {
  BirthdayCleanupDto,
