...
import { avatarKeyFor, isStagedKey } from '@/libs/asset-paths';
...
import { CreateFriendDto, FriendDto, UpdateFriendDto } from './dto/friend.dto';
import { PaginatedFriendsDto } from './dto/friend-search.dto';
import { validateBirthdayInput } from './birthday-visibility';
import {
  canEditProfile,
  PROFILE_INCLUDE,
  toFriendDto,
